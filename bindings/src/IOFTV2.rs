...
pub mod ioftv2 {
    ...
    pub static IOFTV2_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(||
    ::ethers::core::utils::__serde_json::from_str(__ABI).expect("ABI is always valid"));
    pub struct IOFTV2<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IOFTV2<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IOFTV2<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IOFTV2<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IOFTV2<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(IOFTV2)).field(&self.address()).finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IOFTV2<M> {
        ...
        pub fn events(
            &self,
        ) -> ::ethers::contract::builders::Event<::std::sync::Arc<M>, M, IOFTV2Events> {
    ...
    impl ::ethers::contract::EthLogDecode for IOFTV2Events {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(IOFTV2Events::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = CallOFTReceivedSuccessFilter::decode_log(log) {
                return Ok(IOFTV2Events::CallOFTReceivedSuccessFilter(decoded));
            }
            if let Ok(decoded) = MessageFailedFilter::decode_log(log) {
                return Ok(IOFTV2Events::MessageFailedFilter(decoded));
            }
            if let Ok(decoded) = NonContractAddressFilter::decode_log(log) {
                return Ok(IOFTV2Events::NonContractAddressFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(IOFTV2Events::OwnershipTransferredFilter(decoded));
            }
            if let Ok(decoded) = ReceiveFromChainFilter::decode_log(log) {
                return Ok(IOFTV2Events::ReceiveFromChainFilter(decoded));
            }
            if let Ok(decoded) = RetryMessageSuccessFilter::decode_log(log) {
                return Ok(IOFTV2Events::RetryMessageSuccessFilter(decoded));
            }
            if let Ok(decoded) = SendToChainFilter::decode_log(log) {
                return Ok(IOFTV2Events::SendToChainFilter(decoded));
            }
            if let Ok(decoded) = SetMinDstGasFilter::decode_log(log) {
                return Ok(IOFTV2Events::SetMinDstGasFilter(decoded));
            }
            if let Ok(decoded) = SetPrecrimeFilter::decode_log(log) {
                return Ok(IOFTV2Events::SetPrecrimeFilter(decoded));
            }
            if let Ok(decoded) = SetTrustedRemoteFilter::decode_log(log) {
                return Ok(IOFTV2Events::SetTrustedRemoteFilter(decoded));
            }
            if let Ok(decoded) = SetTrustedRemoteAddressFilter::decode_log(log) {
                return Ok(IOFTV2Events::SetTrustedRemoteAddressFilter(decoded));
            }
            if let Ok(decoded) = SetUseCustomAdapterParamsFilter::decode_log(log) {
                return Ok(IOFTV2Events::SetUseCustomAdapterParamsFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(IOFTV2Events::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IOFTV2Events {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for IOFTV2Events {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<CallOFTReceivedSuccessFilter> for IOFTV2Events {
        fn from(value: CallOFTReceivedSuccessFilter) -> Self {
            Self::CallOFTReceivedSuccessFilter(value)
        }
    }
    impl ::core::convert::From<MessageFailedFilter> for IOFTV2Events {
        fn from(value: MessageFailedFilter) -> Self {
            Self::MessageFailedFilter(value)
        }
    }
    impl ::core::convert::From<NonContractAddressFilter> for IOFTV2Events {
        fn from(value: NonContractAddressFilter) -> Self {
            Self::NonContractAddressFilter(value)
        }
    }
    impl ::core::convert::From<OwnershipTransferredFilter> for IOFTV2Events {
        fn from(value: OwnershipTransferredFilter) -> Self {
            Self::OwnershipTransferredFilter(value)
        }
    }
    impl ::core::convert::From<ReceiveFromChainFilter> for IOFTV2Events {
        fn from(value: ReceiveFromChainFilter) -> Self {
            Self::ReceiveFromChainFilter(value)
        }
    }
    impl ::core::convert::From<RetryMessageSuccessFilter> for IOFTV2Events {
        fn from(value: RetryMessageSuccessFilter) -> Self {
            Self::RetryMessageSuccessFilter(value)
        }
    }
    impl ::core::convert::From<SendToChainFilter> for IOFTV2Events {
        fn from(value: SendToChainFilter) -> Self {
            Self::SendToChainFilter(value)
        }
    }
    impl ::core::convert::From<SetMinDstGasFilter> for IOFTV2Events {
        fn from(value: SetMinDstGasFilter) -> Self {
            Self::SetMinDstGasFilter(value)
        }
    }
    impl ::core::convert::From<SetPrecrimeFilter> for IOFTV2Events {
        fn from(value: SetPrecrimeFilter) -> Self {
            Self::SetPrecrimeFilter(value)
        }
    }
    impl ::core::convert::From<SetTrustedRemoteFilter> for IOFTV2Events {
        fn from(value: SetTrustedRemoteFilter) -> Self {
            Self::SetTrustedRemoteFilter(value)
        }
    }
    impl ::core::convert::From<SetTrustedRemoteAddressFilter> for IOFTV2Events {
        fn from(value: SetTrustedRemoteAddressFilter) -> Self {
            Self::SetTrustedRemoteAddressFilter(value)
        }
    }
    impl ::core::convert::From<SetUseCustomAdapterParamsFilter> for IOFTV2Events {
        fn from(value: SetUseCustomAdapterParamsFilter) -> Self {
            Self::SetUseCustomAdapterParamsFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for IOFTV2Events {
    ...
    impl ::ethers::core::abi::AbiDecode for IOFTV2Calls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IOFTV2Calls {
    ...
    impl ::core::fmt::Display for IOFTV2Calls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DefaultPayloadSizeLimit(element) => {
                    ::core::fmt::Display::fmt(element, f)
    ...
    impl ::core::convert::From<DefaultPayloadSizeLimitCall> for IOFTV2Calls {
        fn from(value: DefaultPayloadSizeLimitCall) -> Self {
            Self::DefaultPayloadSizeLimit(value)
        }
    }
    impl ::core::convert::From<NoExtraGasCall> for IOFTV2Calls {
        fn from(value: NoExtraGasCall) -> Self {
            Self::NoExtraGas(value)
        }
    }
    impl ::core::convert::From<PtSendCall> for IOFTV2Calls {
        fn from(value: PtSendCall) -> Self {
            Self::PtSend(value)
        }
    }
    impl ::core::convert::From<PtSendAndCallCall> for IOFTV2Calls {
        fn from(value: PtSendAndCallCall) -> Self {
            Self::PtSendAndCall(value)
        }
    }
    impl ::core::convert::From<AllowanceCall> for IOFTV2Calls {
        fn from(value: AllowanceCall) -> Self {
            Self::Allowance(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for IOFTV2Calls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for IOFTV2Calls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<CallOnOFTReceivedCall> for IOFTV2Calls {
        fn from(value: CallOnOFTReceivedCall) -> Self {
            Self::CallOnOFTReceived(value)
        }
    }
    impl ::core::convert::From<CirculatingSupplyCall> for IOFTV2Calls {
        fn from(value: CirculatingSupplyCall) -> Self {
            Self::CirculatingSupply(value)
        }
    }
    impl ::core::convert::From<CreditedPacketsCall> for IOFTV2Calls {
        fn from(value: CreditedPacketsCall) -> Self {
            Self::CreditedPackets(value)
        }
    }
    impl ::core::convert::From<DecimalsCall> for IOFTV2Calls {
        fn from(value: DecimalsCall) -> Self {
            Self::Decimals(value)
        }
    }
    impl ::core::convert::From<DecreaseAllowanceCall> for IOFTV2Calls {
        fn from(value: DecreaseAllowanceCall) -> Self {
            Self::DecreaseAllowance(value)
        }
    }
    impl ::core::convert::From<EstimateSendAndCallFeeCall> for IOFTV2Calls {
        fn from(value: EstimateSendAndCallFeeCall) -> Self {
            Self::EstimateSendAndCallFee(value)
        }
    }
    impl ::core::convert::From<EstimateSendFeeCall> for IOFTV2Calls {
        fn from(value: EstimateSendFeeCall) -> Self {
            Self::EstimateSendFee(value)
        }
    }
    impl ::core::convert::From<FailedMessagesCall> for IOFTV2Calls {
        fn from(value: FailedMessagesCall) -> Self {
            Self::FailedMessages(value)
        }
    }
    impl ::core::convert::From<ForceResumeReceiveCall> for IOFTV2Calls {
        fn from(value: ForceResumeReceiveCall) -> Self {
            Self::ForceResumeReceive(value)
        }
    }
    impl ::core::convert::From<GetConfigCall> for IOFTV2Calls {
        fn from(value: GetConfigCall) -> Self {
            Self::GetConfig(value)
        }
    }
    impl ::core::convert::From<GetTrustedRemoteAddressCall> for IOFTV2Calls {
        fn from(value: GetTrustedRemoteAddressCall) -> Self {
            Self::GetTrustedRemoteAddress(value)
        }
    }
    impl ::core::convert::From<IncreaseAllowanceCall> for IOFTV2Calls {
        fn from(value: IncreaseAllowanceCall) -> Self {
            Self::IncreaseAllowance(value)
        }
    }
    impl ::core::convert::From<IsTrustedRemoteCall> for IOFTV2Calls {
        fn from(value: IsTrustedRemoteCall) -> Self {
            Self::IsTrustedRemote(value)
        }
    }
    impl ::core::convert::From<LzEndpointCall> for IOFTV2Calls {
        fn from(value: LzEndpointCall) -> Self {
            Self::LzEndpoint(value)
        }
    }
    impl ::core::convert::From<LzReceiveCall> for IOFTV2Calls {
        fn from(value: LzReceiveCall) -> Self {
            Self::LzReceive(value)
        }
    }
    impl ::core::convert::From<MinDstGasLookupCall> for IOFTV2Calls {
        fn from(value: MinDstGasLookupCall) -> Self {
            Self::MinDstGasLookup(value)
        }
    }
    impl ::core::convert::From<NameCall> for IOFTV2Calls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<NonblockingLzReceiveCall> for IOFTV2Calls {
        fn from(value: NonblockingLzReceiveCall) -> Self {
            Self::NonblockingLzReceive(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for IOFTV2Calls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PayloadSizeLimitLookupCall> for IOFTV2Calls {
        fn from(value: PayloadSizeLimitLookupCall) -> Self {
            Self::PayloadSizeLimitLookup(value)
        }
    }
    impl ::core::convert::From<PrecrimeCall> for IOFTV2Calls {
        fn from(value: PrecrimeCall) -> Self {
            Self::Precrime(value)
        }
    }
    impl ::core::convert::From<RenounceOwnershipCall> for IOFTV2Calls {
        fn from(value: RenounceOwnershipCall) -> Self {
            Self::RenounceOwnership(value)
        }
    }
    impl ::core::convert::From<RetryMessageCall> for IOFTV2Calls {
        fn from(value: RetryMessageCall) -> Self {
            Self::RetryMessage(value)
        }
    }
    impl ::core::convert::From<SendAndCallCall> for IOFTV2Calls {
        fn from(value: SendAndCallCall) -> Self {
            Self::SendAndCall(value)
        }
    }
    impl ::core::convert::From<SendFromCall> for IOFTV2Calls {
        fn from(value: SendFromCall) -> Self {
            Self::SendFrom(value)
        }
    }
    impl ::core::convert::From<SetConfigCall> for IOFTV2Calls {
        fn from(value: SetConfigCall) -> Self {
            Self::SetConfig(value)
        }
    }
    impl ::core::convert::From<SetMinDstGasCall> for IOFTV2Calls {
        fn from(value: SetMinDstGasCall) -> Self {
            Self::SetMinDstGas(value)
        }
    }
    impl ::core::convert::From<SetPayloadSizeLimitCall> for IOFTV2Calls {
        fn from(value: SetPayloadSizeLimitCall) -> Self {
            Self::SetPayloadSizeLimit(value)
        }
    }
    impl ::core::convert::From<SetPrecrimeCall> for IOFTV2Calls {
        fn from(value: SetPrecrimeCall) -> Self {
            Self::SetPrecrime(value)
        }
    }
    impl ::core::convert::From<SetReceiveVersionCall> for IOFTV2Calls {
        fn from(value: SetReceiveVersionCall) -> Self {
            Self::SetReceiveVersion(value)
        }
    }
    impl ::core::convert::From<SetSendVersionCall> for IOFTV2Calls {
        fn from(value: SetSendVersionCall) -> Self {
            Self::SetSendVersion(value)
        }
    }
    impl ::core::convert::From<SetTrustedRemoteCall> for IOFTV2Calls {
        fn from(value: SetTrustedRemoteCall) -> Self {
            Self::SetTrustedRemote(value)
        }
    }
    impl ::core::convert::From<SetTrustedRemoteAddressCall> for IOFTV2Calls {
        fn from(value: SetTrustedRemoteAddressCall) -> Self {
            Self::SetTrustedRemoteAddress(value)
        }
    }
    impl ::core::convert::From<SetUseCustomAdapterParamsCall> for IOFTV2Calls {
        fn from(value: SetUseCustomAdapterParamsCall) -> Self {
            Self::SetUseCustomAdapterParams(value)
        }
    }
    impl ::core::convert::From<SharedDecimalsCall> for IOFTV2Calls {
        fn from(value: SharedDecimalsCall) -> Self {
            Self::SharedDecimals(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for IOFTV2Calls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for IOFTV2Calls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TokenCall> for IOFTV2Calls {
        fn from(value: TokenCall) -> Self {
            Self::Token(value)
        }
    }
    impl ::core::convert::From<TotalSupplyCall> for IOFTV2Calls {
        fn from(value: TotalSupplyCall) -> Self {
            Self::TotalSupply(value)
        }
    }
    impl ::core::convert::From<TransferCall> for IOFTV2Calls {
        fn from(value: TransferCall) -> Self {
            Self::Transfer(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for IOFTV2Calls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for IOFTV2Calls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<TrustedRemoteLookupCall> for IOFTV2Calls {
        fn from(value: TrustedRemoteLookupCall) -> Self {
            Self::TrustedRemoteLookup(value)
        }
    }
    impl ::core::convert::From<UseCustomAdapterParamsCall> for IOFTV2Calls {
